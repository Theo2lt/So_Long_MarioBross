...
void ft_mouve_perso_haut(int keycode ,char **tab, t_map *map, t_data *data)
{
	...
	if(keycode == 119)
	{
		if((tab[data->perso->position_y-1][data->perso->position_x] != '1' && tab[data->perso->position_y-1][data->perso->position_x] != '3') && tab[data->perso->position_y-1][data->perso->position_x] != 'E')
		{
...
void ft_mouve_perso_bas(int keycode ,char **tab, t_map *map, t_data *data)
{
	...
	if(keycode == 115)
	{
		...
		{
			if(tab[data->perso->position_y+1][data->perso->position_x] == 'E')
			{
				if (data->map->nbr_C == 0)
					ft_exit(data);
			}
...
void ft_mouve_perso_droite(int keycode ,char **tab, t_map *map, t_data *data)
{
	...
	if(keycode == 100)
	{
		if(tab[data->perso->position_y][data->perso->position_x+1] != '1' && tab[data->perso->position_y][data->perso->position_x+1] != '3' && tab[data->perso->position_y][data->perso->position_x+1] != '2' && tab[data->perso->position_y][data->perso->position_x+1] != 'E')
		{
